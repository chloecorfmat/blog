    ...
    <main role="main" id="main" tabindex="0">
        <div class="list-articles">
            ...
            <div class="list-articles__content">
                <header>
                    <h1 class="list-articles__title">Le blog de l'accessibilité numérique</h1>
                    <p class="list-articles__text"><?php echo get_field('homepage_introduction', 'option') ?></p>
                </header>
                    ...
                    <div class="list-articles__list">
                        ...
                        <?php if( have_posts() ) : while( have_posts() ) : the_post(); ?>
                            <article class="list-articles__item" data-expand-target>
                                ...
                                <p class="list-articles__item-text"><?php echo get_field('article_excerpt'); ?></p>
